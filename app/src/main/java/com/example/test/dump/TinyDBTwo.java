...
public class TinyDBTwo {

    private final SharedPreferences preferences;
    private String DEFAULT_APP_IMAGEDATA_DIRECTORY;
    private String lastImagePath = "";

    public TinyDBTwo(Context appContext) {
    ...
    public ArrayList<RewardsDomain> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<RewardsDomain> playerList =  new ArrayList<RewardsDomain>();

        for(String jObjString : objStrings){
            RewardsDomain player  = gson.fromJson(jObjString,  RewardsDomain.class);
    ...
    public void putListObject(String key, ArrayList<RewardsDomain> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(RewardsDomain player: playerList){
