...
public class Latte extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        minus.setOnClickListener(view -> {
            if (quantity_i == 0)
                Toast.makeText(Latte.this, "Please no", Toast.LENGTH_SHORT).show();
            else {
                int base_price = 90, coffee_price;
                quantity_i--;
                displayQuantity();
        ...
        go_back_info.setOnClickListener(view -> startActivity(new Intent(this, OrderActivity.class)));
    }
